            ...
            <div className="relative h-[min(62vh,420px)] sm:h-80 rounded-2xl bg-black border-2 border-teal-500/40 overflow-hidden">
              ...
              <div className="absolute top-3 right-3 flex items-center gap-2">
                <button
                  ...
                  className="relative z-30 rounded-full bg-slate-950/90 backdrop-blur px-3 py-2 text-[10px] sm:text-xs !text-white font-semibold flex items-center gap-2 border border-white/30 shadow-lg hover:bg-slate-900"
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-2">
                <span className="relative z-30 rounded-full bg-slate-950/90 backdrop-blur px-3 py-1.5 text-[10px] sm:text-xs !text-white font-semibold flex items-center gap-2 border border-white/20 shadow-lg">
                ...
                {(cameraState === 'denied' || cameraState === 'error' || cameraState === 'unsupported') && (
                  <button onClick={resetScanner} className="relative z-30 rounded-full bg-teal-400 !text-slate-950 px-3 py-1.5 text-[10px] font-extrabold flex items-center gap-1.5 shadow-lg">
