        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400">
              ...
              {onOpenLogos && (
                <li>
                  <button onClick={onOpenLogos} className="text-emerald-400 hover:text-emerald-300 transition cursor-pointer font-bold flex items-center gap-1">
                    <Sparkles className="w-3 h-3" />
                    <span>Бренд-кит и логотипы</span>
                  </button>
                </li>
              )}
            </ul>
