        ...
        {cards.map((card) => {
          ...
          return (
            <button
              ...
              className={`relative text-left p-5 rounded-2xl bg-white border transition-all duration-300 group cursor-pointer shadow-xs ${
                isActive
                  ? `bg-gradient-to-b ${card.gradient} ${card.activeBorder} shadow-md`
                  : `border-slate-200 ${card.borderColor} hover:bg-slate-50 hover:-translate-y-1 hover:shadow-md`
              }`}
            >
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="flex items-center justify-between gap-2 mb-4">
                  <div
                    className={`w-11 h-11 rounded-xl ${card.iconBg} flex items-center justify-center shadow-xs transform group-hover:scale-105 transition-transform duration-200`}
                  >
                ...
                <div>
                  <h3 className="text-base font-extrabold text-slate-900 group-hover:text-teal-700 transition-colors flex items-center justify-between">
